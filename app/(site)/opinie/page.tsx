...
import { getOpiniePageContent, getTestimonials } from '@/lib/content'
...
export async function generateMetadata(): Promise<Metadata> {
  const cms = await getOpiniePageContent()
  return {
...
export default async function OpiniePage() {
  ...
  const [testimonials, cms] = await Promise.all([getTestimonials(), getOpiniePageContent()])
